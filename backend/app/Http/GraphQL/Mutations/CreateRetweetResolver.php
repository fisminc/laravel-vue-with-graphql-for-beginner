...
class CreateRetweetResolver
{
    ...
    public function resolve($rootValue, array $args, GraphQLContext $context = null, ResolveInfo $resolveInfo)
    {
        ...
        $retweet = $this->createRetweet($account, $tweet, $args);
    ...
    protected function createRetweet(Account $account, Tweet $tweet, array $args)
    {
        return Retweet::create([
            'account_id'        => $account->id,
            'tweet_id'          => $tweet->id,
            'original_tweet_id' => $args['tweet_id'],
            'retweeted_at'      => Carbon::now(),
        ]);
    }
